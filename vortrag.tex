...
\begin{frame}{Apps}
	\begin{itemize}
		...
		\item Meißt für alle wichtigen Platformen verfügbar
...
\begin{frame}{Rich Communication Suite-enhanced (RCS-e)}{Übersicht}
	\begin{itemize}
		...
		\item Nutz das \textit{IP Multimedia Subsystem (IMS)}
		\item Bestandteile:
		\begin{itemize}
	...
	\tiny{
		\begin{tabular}{c|lll}
			...
			Vorteile & + saubere Integeration ins OS & + plattformübergreifend & + plattformübergreifend \\
								...
								& + kostenlos	&  & + implementiert durch Netzbetreiber	\\
								& & & + offener Standard \\
							 & & & \\
